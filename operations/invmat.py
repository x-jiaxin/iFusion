...
def batch_pinv_dx(x):
    ...
    db1 = db_ds.contiguous().view(batch_size, w * w, w * w).bmm(ds_dx.contiguous().view(batch_size, w * w, h * w))
    db_dx = db1.contiguous().view(batch_size, w, w, h, w)  # [j, i, m, n]
...
if __name__ == '__main__':
    def _test():
        ...
        print(t1.matmul(t2.permute(0, 2, 1)))
        # print(t1)
        # print(t2)
        # print(t1 - t2)
