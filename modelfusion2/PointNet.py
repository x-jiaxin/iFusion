...
class PointNet(nn.Module):
    ...
    def forward(self, *args):
        ...
        fusionS1 = fusion()(featureS1, featureT1)

        featureS2 = F.relu(self.conv2S(fusionS1))  # 64
        featureT2 = F.relu(self.conv2T(featureT1))
        fusionS2 = fusion()(featureS2, featureT2)

        featureS3 = F.relu(self.conv3S(fusionS2))  # 64
        featureT3 = F.relu(self.conv3T(featureT2))
        fusionS3 = fusion()(featureS3, featureT3)

        featureS4 = F.relu(self.conv4S(fusionS3))  # 128
        featureT4 = F.relu(self.conv4T(featureT3))
        fusionS4 = fusion()(featureS4, featureT4)

        featureS5 = F.relu(self.conv5S(fusionS4))  # 1024
        featureT5 = F.relu(self.conv5T(featureT4))
        fusionS5 = fusion()(featureS5, featureT5)
