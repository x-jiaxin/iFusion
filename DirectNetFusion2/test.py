...
if __name__ == '__main__':
    ...
    # model.to(device)
    test_loss, translation_error, rotation_error, Transformation_error = \
        test_one_epoch(device, model, testloader)
    info = "Test Loss: {}, Rotation Error: {} & Translation Error: {} & Transformation Error: {}". \
        format(test_loss, rotation_error, translation_error, Transformation_error)
    print(info)
