...
from train import exp_name, MAX_EPOCHS, getModel, dirName

BATCH_SIZE = 32
EVAL = False
START_EPOCH = 0
pretrained = os.path.join(dirName, 'best_model.t7')  # 使用最好的模型参数测试
print(exp_name)
...
if __name__ == '__main__':
    ...
    if pretrained:
        model.load_state_dict(torch.load(pretrained, map_location='cuda:1'))
    # model.to(device)
